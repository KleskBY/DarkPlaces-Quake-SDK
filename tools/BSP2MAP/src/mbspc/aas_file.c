...
qboolean AAS_LoadAASFile(char *filename, int fpoffset, int fplength)
{
  ...
  aasworld.bboxes =
    (aas_bbox_t *) AAS_LoadAASLump(fp, offset, length, aasworld.bboxes);
  if (!aasworld.bboxes)
    return false;
  ...
  aasworld.vertexes =
    (aas_vertex_t *) AAS_LoadAASLump(fp, offset, length, aasworld.vertexes);
  ...
  aasworld.planes =
    (aas_plane_t *) AAS_LoadAASLump(fp, offset, length, aasworld.planes);
  if (!aasworld.planes)
    return false;
  ...
  aasworld.edgeindex =
    (aas_edgeindex_t *) AAS_LoadAASLump(fp, offset, length,
                                        aasworld.edgeindex);
  ...
  aasworld.faces =
    (aas_face_t *) AAS_LoadAASLump(fp, offset, length, aasworld.faces);
  if (!aasworld.faces)
    return false;
  ...
  aasworld.faceindex =
    (aas_faceindex_t *) AAS_LoadAASLump(fp, offset, length,
                                        aasworld.faceindex);
  ...
  aasworld.areas =
    (aas_area_t *) AAS_LoadAASLump(fp, offset, length, aasworld.areas);
  if (!aasworld.areas)
    return false;
  ...
  aasworld.areasettings =
    (aas_areasettings_t *) AAS_LoadAASLump(fp, offset, length,
                                           aasworld.areasettings);
  ...
  aasworld.reachability =
    (aas_reachability_t *) AAS_LoadAASLump(fp, offset, length,
                                           aasworld.reachability);
  ...
  aasworld.portalindex =
    (aas_portalindex_t *) AAS_LoadAASLump(fp, offset, length,
                                          aasworld.portalindex);
  ...
  aasworld.clusters =
    (aas_cluster_t *) AAS_LoadAASLump(fp, offset, length, aasworld.clusters);
...
//===========================================================================
int
AAS_WriteAASLump(FILE * fp, aas_header_t * h, int lumpnum, void *data,
                 int length)
{
  aas_lump_t *lump;
...
qboolean AAS_WriteAASFile(char *filename)
{
  ...
  if (!AAS_WriteAASLump(fp, &header, AASLUMP_PORTALS, aasworld.portals,
    ...
    return false;
  if (!AAS_WriteAASLump
      (fp, &header, AASLUMP_PORTALINDEX, aasworld.portalindex,

...
//===========================================================================
void
SplitBrush2(bspbrush_t * brush, int planenum,
...
// Changes Globals:             -
//===========================================================================
bspbrush_t *ClipBrushToBox(bspbrush_t * brush, vec3_t clipmins,
                           vec3_t clipmaxs)
{
  int i, j;
  bspbrush_t *front, *back;
                             ...
                             vec3_t clipmins, vec3_t clipmaxs)
{
  ...
  for (i = startbrush; i < endbrush; i++)
  {
    ...
    for (j = 0; j < numsides; j++)
      if ((mb->original_sides[j].flags & SFL_VISIBLE)
          && mb->original_sides[j].winding)
        vis++;
#if 0
    if (!vis)

...
#define	HL_MAX_MAP_MODELS			512
#define	HL_MAX_MAP_BRUSHES		65536
#define	HL_MAX_MAP_ENTITIES		16384
#define	HL_MAX_MAP_ENTSTRING		(2048*1024)

#define	HL_MAX_MAP_PLANES			65536
#define	HL_MAX_MAP_NODES			65536		// because negative shorts are contents
#define	HL_MAX_MAP_CLIPNODES		65536		//
...
#define	HL_MAX_MAP_TEXINFO		65536
#define	HL_MAX_MAP_EDGES			256000
#define	HL_MAX_MAP_SURFEDGES		512000
#define	HL_MAX_MAP_TEXTURES		4096
#define	HL_MAX_MAP_MIPTEX			0x2000000
#define	HL_MAX_MAP_LIGHTING		0x3000000
#define	HL_MAX_MAP_VISIBILITY	0x800000

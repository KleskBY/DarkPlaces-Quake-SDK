...
{
  optimized->vertexes =
    (aas_vertex_t *) GetClearedMemory(aasworld.numvertexes *
				      sizeof(aas_vertex_t));
  ...
  optimized->edgeindex =
    (aas_edgeindex_t *) GetClearedMemory(aasworld.edgeindexsize *
  ...
  optimized->faceindex =
    (aas_faceindex_t *) GetClearedMemory(aasworld.faceindexsize *

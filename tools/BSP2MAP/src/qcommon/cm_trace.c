...
*/
void
RotatePoint(vec3_t point, /*const */ vec3_t matrix[3])
{				// FIXME 
  vec3_t tvec;
...
*/
void
TransposeMatrix( /*const */ vec3_t matrix[3], vec3_t transpose[3])
{				// FIXME
  int i, j;
  for (i = 0; i < 3; i++)
  {
...
*/
void
CM_ProjectPointOntoVector(vec3_t point, vec3_t vStart, vec3_t vDir,
			  vec3_t vProj)
{
  vec3_t pVec;
...
*/
void
CM_TraceThroughSphere(traceWork_t * tw, vec3_t origin, float radius,
		      vec3_t start, vec3_t end)
{
  ...
  c =
    v1[0] * v1[0] + v1[1] * v1[1] + v1[2] * v1[2] - (radius +
						     RADIUS_EPSILON) *
...
*/
void
CM_TraceThroughVerticalCylinder(traceWork_t * tw, vec3_t origin,
				float radius, float halfheight, vec3_t start,
				vec3_t end)
{
  ...
  c =
    v1[0] * v1[0] + v1[1] * v1[1] - (radius + RADIUS_EPSILON) * (radius +
								 RADIUS_EPSILON);
...
*/
void
CM_TraceThroughTree(traceWork_t * tw, int num, float p1f, float p2f,
		    vec3_t p1, vec3_t p2)
{
  cNode_t *node;
  cplane_t *plane;
...
*/
void
CM_Trace(trace_t * results, const vec3_t start, const vec3_t end,
...
*/
void
CM_TransformedBoxTrace(trace_t * results, const vec3_t start,

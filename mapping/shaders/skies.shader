...
textures/skies/kc_dm10sky
{
	...
	q3map_sun	.1 .1 .1 90 225 55
	q3map_surfacelight 1150
...
textures/skies/halo
{
	...
	q3map_surfacelight 410
	q3map_sun	.5 .6 .8 90 225 55

	qer_editorimage textures/skies/halo_up.tga
...
textures/skies/skybox
{
	...
	qer_editorimage textures/skies/DMCW_UP.tga


	skyparms env/DMCW - -
}

textures/skies/zanzibar
{
	surfaceparm noimpact
	surfaceparm nolightmap
...
{ 
	surfaceparm nonsolid	
        ...
        sort 6 
        {
		clampmap textures/sfx/storm.tga
                tcmod rotate 8
                blendFunc blend

...
textures/common/terrain_coagulation
{
	surfaceparm nodraw
	surfaceparm nomarks
 	surfaceparm nolightmap
...

{
...

	{
		...
		map textures/stone/forge_halo_grass_diff.jpg
		rgbGen vertex
		tcmod scale 0.125 0.125
	}	
}

textures/terrain/cpterra2_1

{
...

	{
		...
		map textures/stone/forge_halo_gravel_dirt_diff.jpg
		rgbGen vertex
		tcmod scale 0.1 0.1
...
textures/terrain/cpterra2_2
{
...

	{
		...
		map textures/stone/grass_reach_coagulation.tga
		tcmod scale 0.05 0.05
		rgbGen vertex
	}
...
textures/terrain/cpterra2_0to1
...
textures/terrain/cpterra2_0to2
{
	surfaceparm nolightmap
	q3map_novertexshadows
	q3map_forcesunlight
...
textures/terrain/cpterra2_1to2
{
	surfaceparm nolightmap
	q3map_novertexshadows
	q3map_forcesunlight
